        ...
        <div className="row mt-4" data-aos="zoom-out-up">
            {
                ...
                (
                    animales.map((animal) => {
                        const nombreArchivo = animal.imagen_url.replace('https://imglanek.s3.us-east-1.amazonaws.com/', '');
                            ...
                            <div className="card h-100 animal-list mx-auto">
                                ...
                                <div>
                                    <div className='d-flex justify-content-center'>
                                        <a
                                            href={`${VITE_API_URL}/animales/descargar/${encodeURIComponent(nombreArchivo)}`}
